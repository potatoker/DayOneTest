...
public class LoginActivity extends AppCompatActivity implements DataPresenter.Login{
...
//                    }
//                }, 3000);
        DataPresenter.Login(email, password, this);
    }
...
//                this.finish();
    ...
    @Override
    public void onLogin(User user, Boolean ok) {
        progressDialog.dismiss();
        if(ok){
