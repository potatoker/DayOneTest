 ...
 */
public class ExploreAdapter2 extends RecyclerView.Adapter<ExploreAdapter2.ExploreViewHolder>{
    ...
    public ExploreAdapter2(List<ExploreDay> days, Context context){
        this.days = days;
    ...
    public void onBindViewHolder(ExploreViewHolder holder, int position) {
        ...
        Utils.loadImage(holder.big, Uri.parse(moments.get(0).getRemote_url()),context, context.getResources().getDimensionPixelSize(R.dimen.big_photo_size));
        Utils.loadImage(holder.img1, Uri.parse(moments.get(1).getRemote_url()), context, context.getResources().getDimensionPixelSize(R.dimen.small_photo_size));
        Utils.loadImage(holder.img2, Uri.parse(moments.get(2).getRemote_url()), context, context.getResources().getDimensionPixelSize(R.dimen.small_photo_size));
